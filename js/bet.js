...
function calculateWinnings(fight1, blackjack1, double1, fight2, blackjack2, double2, insurance, bet1, bet2) {
    console.log(fight1, blackjack1, double1, fight2, blackjack2, double2, insurance, bet1, bet2);
    let totalWinnings = 
        calculateHandWinnings(fight1, blackjack1, bet1) + 
        calculateHandWinnings(fight2, blackjack2, bet2);

    maxBet += totalWinnings + (insurance ? currentBet : 0);
